...
#
# GPU example VM base module for NVIDIA Orin.
#
...
# (kernel, DTB, vfio) is layered on by this repository's passthrough module.
#
{
  lib,
  pkgs,
...
in
{
  ...
  environment.systemPackages =
    ...
    ++ [
      ...
      (pkgs.callPackage ../../packages/gpu-load/package.nix {
